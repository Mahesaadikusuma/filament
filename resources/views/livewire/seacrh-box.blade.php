{{-- ini menggunakan livewire search --}}
{{-- <div id="search-box">
    <div>
        ...
        <div class="w-52 flex rounded-2xl bg-gray-100 py-2 px-3 mb-3 items-center">
            ...
            Bisa pakai yang diatas jika ingin live search
            <input wire:model='search' wire:keydown.enter='update'
        ...
        <x-button wire:click="update" wire:keydown.enter='update'>Search</x-button>
    </div>
</div> --}}
